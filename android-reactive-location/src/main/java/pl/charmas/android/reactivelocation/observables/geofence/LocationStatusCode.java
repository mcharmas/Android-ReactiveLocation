...
public enum LocationStatusCode {
  ...
  GEOFENCE_TOO_MANY_PENDING_INTENTS(LocationStatusCodes.GEOFENCE_TOO_MANY_PENDING_INTENTS,
      "GEOFENCE_TOO_MANY_PENDING_INTENTS"),
  GEOFENCE_TOO_MANY_GEOFENCES(LocationStatusCodes.GEOFENCE_TOO_MANY_PENDING_INTENTS,
      "GEOFENCE_TOO_MANY_PENDING_INTENTS"),
  ...
  static LocationStatusCode fromCode(int statusCode) {
    for (LocationStatusCode code : LocationStatusCode.values()) {
      if (code.statusCode == statusCode) return code;
    }
    return UNKNOWN;
  }
