...
public class ReactiveLocationProvider {
   ...
   * Observable can report {@link pl.charmas.android.reactivelocation.observables.LocationConnectionException}
   * when there are trouble connecting with Google Play Services and other exceptions that
   * can be thrown on {@link com.google.android.gms.location.LocationClient#requestLocationUpdates(com.google.android.gms.location.LocationRequest,
   ...
   * reported only on {@link com.google.android.gms.location.LocationStatusCodes#ERROR}. Every
   * other
   * status is included in {@link pl.charmas.android.reactivelocation.observables.geofence.AddGeofenceResult}.
   * <p/>
   * Other exceptions will be reported that can be thrown on {@link com.google.android.gms.location.LocationClient#addGeofences(java.util.List,
   * android.app.PendingIntent, com.google.android.gms.location.LocationClient.OnAddGeofencesResultListener)}.
   * <p/>
   ...
   */
  public Observable<Result> addGeofences(PendingIntent geofenceTransitionPendingIntent,
   ...
   * <p/>
   * The {@link pl.charmas.android.reactivelocation.observables.geofence.RemoveGeofencesException}
   * is
   * reported only on {@link com.google.android.gms.location.LocationStatusCodes#ERROR}. Every
   * other
   * status is included in {@link pl.charmas.android.reactivelocation.observables.geofence.RemoveGeofencesResult}.
   * <p/>
   * Other exceptions will be reported that can be thrown on {@link com.google.android.gms.location.LocationClient#removeGeofences(android.app.PendingIntent,
   ...
   */
  public Observable<RemoveGeofencesResult.PengingIntentRemoveGeofenceResult> removeGeofences(
   ...
   * status is included in {@link pl.charmas.android.reactivelocation.observables.geofence.RemoveGeofencesResult}.
   * <p/>
   * Other exceptions will be reported that can be thrown on {@link com.google.android.gms.location.LocationClient#removeGeofences(java.util.List,
   * com.google.android.gms.location.LocationClient.OnRemoveGeofencesResultListener)}.
   * <p/>
   * Every exception is delivered by {@link rx.Observer#onError(Throwable)}.
   *
   ...
   * @return observable that removed geofences
   */
  public Observable<RemoveGeofencesResult.RequestIdsRemoveGeofenceResult> removeGeofences(
